...
int main(int argc, char *argv[]) {
  ...
  if (!vm.count("input_file") || !vm.count("output_file") || !vm.count("cut_bubble_size")) {
    cout << "usage: polyomino [<options>]" << endl << opt << endl;
    exit(0);
  }
  ...
  cout << "input file:  " << input_file << endl
       ...
       << "inversion:   " << inversion << endl
       << endl
       << "info file:   " << flag_info << endl
       << "data file:   " << flag_data << endl
       << "detail file: " << flag_data_detail << endl;

  Calculator::Parameter p = {input_file, output_file, A, B, C, D, E, F, gamma, cut_bubble_size, rotation, inversion};
